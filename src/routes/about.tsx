        ...
        <div className="bg-white border p-8 pb-16">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
            <p className="leading-relaxed">
              ...
              Ethereum, that automates yield generation strategies across
              various DeFi platforms. Founded in 2020, Yearn is one of the most
              trusted and innovative protocols in the DeFi ecosystem.
            </p>
            ...
            <p className="leading-relaxed">
              ...
              analysis, and strategy breakdowns. It's designed to help users
              make informed decisions about their DeFi investments. For more
