    ...
    <div className="container mx-auto max-w-4xl">
      <div className="bg-white border p-8">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
          ...
          <p className="leading-relaxed">
            DeFi protocols and cryptocurrency investments carry risks, including
            but not limited to:
          </p>
          ...
          <p className="leading-relaxed">
            ...
            Yearn vaults, we make no warranties or guarantees regarding the
            accuracy, completeness, or reliability of the data. Metrics such as
            APY, TVL, and strategy information are best-effort representations
            and may not reflect real-time conditions.
          </p>
