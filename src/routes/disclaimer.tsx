      ...
      <div className="w-full mx-auto max-w-4xl px-0 sm:px-6">
        <div className="bg-white border p-8 pb-16">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
            ...
            <p className="leading-relaxed">
              DeFi protocols and cryptocurrency investments carry risks,
            ...
            <p className="leading-relaxed">
              ...
              about Yearn vaults, we make no warranties or guarantees regarding
              the accuracy, completeness, or reliability of the data. Metrics
              such as APY, TVL, and strategy information are best-effort
            ...
            <p className="leading-relaxed">
              ...
              links to external platforms are provided for convenience and do
              not constitute an endorsement of those services.
            </p>
            ...
            <p className="leading-relaxed">
              ...
              platforms, are provided for convenience. We are not responsible
